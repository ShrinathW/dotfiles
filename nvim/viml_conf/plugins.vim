...
nnoremap <silent> <leader>l :<C-U>Leaderf rg --no-messages --popup<CR>
nnoremap <silent> <leader>g :<C-U>Leaderf rg --cword --no-messages --popup<CR>
...
" Search recent files
nnoremap <silent> <leader>p :<C-U>Leaderf mru --popup --absolute-path<CR>
...
nnoremap <silent> <leader>z :MundoToggle<CR>
