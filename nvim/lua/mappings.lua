...
keymap.set("n", "<leader>fp", "m`o<ESC>p``", { desc = "paste below current line" })
keymap.set("n", "<leader>fP", "m`O<ESC>p``", { desc = "paste above current line" })
...
keymap.set("n", "<S-right>", "<cmd>tabnext<cr>", {
  silent = true
})

keymap.set("n", "<S-left>", "<cmd>tabprevious<cr>", {
  silent = true
})
